...
// Removed tracepoint_generator.h and tracepoint_manager.h as tracepoint functionality is not needed in standalone PEM
...
class VizierServer final : public api::vizierpb::VizierService::Service {
 public:
  ...
  ::grpc::Status ExecuteScript(
    ...
    // Mutation handling removed as tracepoint functionality is not needed in standalone PEM
